...
`paper-radar` is in active early-stage development. The current focus is:

- improving source reliability
- making ranking more relevant for architecture and LLM research
- keeping the report short and high-signal
- making local setup and scheduled runs easy to reproduce

The project is usable now, but ranking heuristics and source parsing should still be treated as evolving.
...
如果你准备提交改动，先阅读 [CONTRIBUTING.md](CONTRIBUTING.md)。
...
## 值得扫摘要
### 1. On Neural Scaling Laws for Weather Emulation through Continual Training
- 分数：7.0
- 发布时间：2026-03-26
- 来源：arXiv
- 标签：transformer architecture, scaling law
- 作者：...
- 链接：http://arxiv.org/abs/2603.25687v1
- 一句话总结（中文）：该文分析 transformer architecture, scaling law，核心内容是 ...
- One-line summary (en-US): The paper analyzes transformer architecture, scaling law and centers on ...
- 推荐理由：
  - 命中高优先级关键词
```
...
- Please keep PRs scoped to one problem when possible.
- For ranking changes, include a short explanation of expected behavior changes.
